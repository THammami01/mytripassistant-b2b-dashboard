...
export const columns = [
  ...
  { name: "App", uid: "app", sortDirection: "ascending" },
  { name: "Transaction ID", uid: "transactionId" },
  { name: "User ID", uid: "userId" },
  { name: "Date", uid: "date", sortDirection: "ascending" },
  { name: "Country", uid: "country", sortDirection: "ascending" },
  { name: "OS", uid: "os", sortDirection: "ascending" },
  { name: "Device", uid: "device", sortDirection: "ascending" },
  { name: "IP", uid: "ip" },
  { name: "Actions", uid: "actions" },
];
...
export const users: Users[] = generateMockUserData(0);
