  ...
  const renderCell = useMemoizedCallback(
    (user: Users, columnKey: React.Key) => {
      ...
      switch (userKey) {
        ...
        case "teams":
          return (
            <div className="flex gap-1 float-start">
        ...
        case "role":
          return (
            <div className="capitalize text-nowrap text-small text-default-foreground">
              {cellValue}
            </div>
          );
        case "workerType":
    ...
    return (
      <div className="flex items-center gap-4 overflow-auto px-[6px] py-[4px]">
        <div className="flex items-center gap-3">
          ...
          <div className="text-sm whitespace-nowrap text-default-800">
          ...
          {(filterSelectedKeys === "all" || filterSelectedKeys.size > 0) && (
            <Dropdown>
              ...
              <DropdownMenu aria-label="Selected Actions">
                ...
                <DropdownItem key="download-csv">Download CSV</DropdownItem>
              </DropdownMenu>
            </Dropdown>
          )}
        </div>
  ...
  return (
    <div className="w-full h-full">
      ...
      >
        ...
        <TableBody
          emptyContent={
            <div className="flex items-center justify-center h-[calc(100vh-28.5rem)]">
              No data found
            </div>
          }
          items={sortedItems}
