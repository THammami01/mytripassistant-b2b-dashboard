      ...
      <section className="flex flex-col flex-nowrap">
        <div className="flex flex-col justify-between p-6 gap-y-2">
          <div className="flex flex-col gap-y-2">
            <div className="flex flex-col gap-y-0">
              <dt className="font-medium text-medium text-foreground">
                Analytics
              </dt>
            </div>
            <Spacer y={2} />
                  ...
                  <div className="flex flex-col w-full gap-y-0">
                    {payload?.map((p, index) => {
                      ...
                      return (
                        ...
                        >
                          <div className="flex items-center w-full gap-x-1 text-small text-background">
                    ...
                    <span className="font-medium text-small text-foreground-400">
        ...
        >
          <DropdownTrigger>
            <Button
              isIconOnly
              className="absolute w-auto rounded-full right-2 top-2"
              size="sm"
              variant="light"
            >
